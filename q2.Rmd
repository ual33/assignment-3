...
- In each round
    - each player draws `x + 1` cards where `x` follows poisson distribution with mean 2
    - if `x + 1` is greater than the number of remaining cards in the deck, resuffle the deck and draw `x + 1` cards from the suffled deck
...
The R6 class `CardGame` has the following methods: 
